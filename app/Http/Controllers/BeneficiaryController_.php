    ...
    public function downloadIdCard(Beneficiary $beneficiary)
{
    ...
    $html = view('admin.beneficiaries.id-card-pdf-dompdf', compact('beneficiary', 'logoBase64', 'beneficiaryPhotoBase64', 'spousePhotoBase64', 'childrenPhotosBase64', 'qrCodeBase64'))->render();
...
public function generateBulkIdCards(Request $request)
{
    try {
        ...
        $allHtml = '<style>.card-spacing { margin-bottom: 15mm; }</style>';
        foreach ($beneficiaries as $beneficiary) {
            // Convert beneficiary photo to base64
            $beneficiaryPhotoBase64 = null;
            if ($beneficiary->photo) {
