    ...
    <div class="container">
            ...
            <div class="card-header">
                <div class="logo-section">
                    <div class="logo-circle">
                        @if ($logoBase64)
                            <img src="{{ $logoBase64 }}" style="width: 60px;" class="header-brand-img desktop-logo"
                                alt="logo">
                        @else
                            <div style="width: 70px; height: 70px; background: #ccc; text-align: center;">No Logo</div>
                        @endif
                    </div>
                ...
                <div class="qr-section">
                    <div class="qr-code-header">
                        @if ($qrCodeBase64)
                            <img src="{{ $qrCodeBase64 }}" style="width: 60px; height: 60px;" alt="QR Code">
                        @else
                            <div
        ...
        <div class="id-card dependants-card">
            ...
            <div class="dependants-header">
                <div class="dependants-title">{{ $beneficiary->boschma_no }} DEPENDANTS</div>
            ...
            <div class="footer-summary">
                <div class="footer-text">
                    THIS IS TO CERTIFY THAT THE PERSON WHOSE NAME AND PHOTOGRAPH APPEARS OVERLEAF IS A BENEFICIARY OF
                    FORMAL SECTOR SCHEME UNDER THE BORNO STATE CONTRIBUTORY HEALTH CARE MANAGEMENT AGENCY
                </div>
