    ...
    <div class="container">
        ...
        <div class="id-card principal-card">
            ...
            <div class="card-header">
                <div style="position: fixed; top:30px; left:5px;">
                    @if ($logoBase64)
                        <img src="{{ $logoBase64 }}" style="width: 90px;" class="header-brand-img desktop-logo"
                            alt="logo">
                    @else
                ...
                <div style="position: fixed; top: 30px; right:5px;">
                    <div class="qr-code-header">
                        @if ($qrCodeBase64)
                            <img src="{{ $qrCodeBase64 }}" style="width: 90px; height: 90px;" alt="QR Code">
                        @else
                            <div
                ...
                <div class="logo-section">
                    <div class="agency-info">
                        <div class="agency-name">BORNO STATE CONTRIBUTORY HEALTHCARE</div>
                        <div class="agency-subtitle">MANAGEMENT AGENCY</div>
                        <div class="agency-subtitle">(BOSCHMA)</div>
                        <div style="font-size: 2.4mm; margin-top: 0.3mm; font-style: italic;">"Wellness
                            for sustainable development"</div>
                        <div style="font-size: 2.3mm; margin-top: 0.2mm; color: #000000;">
                            No. 7 Lagos Street, Adjacent Lagos House,<br> Maiduguri, Borno State<br>
                            08122224040 | info@boschma.bo.gov.ng <br> boschma.bo.gov.ng
                        </div>
