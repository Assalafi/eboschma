            ...
            <div class="card custom-card">
                <div class="card-body">
                    <div class="d-flex justify-content-between mb-4">
                        <div>
                            <h6 class="main-content-label mb-1">Add New Civil Servant</h6>
                            <p class="text-muted card-sub-title">Please fill in all required fields marked with <span class="text-danger">*</span></p>
                        </div>
                        <div>
                    ...
                    @endif
                            <form action="{{ route('civil-servants.store') }}" method="POST">
                                @csrf
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="dp_no" class="form-control @error('dp_no') is-invalid @enderror" 
                                                   value="{{ old('dp_no') }}" placeholder="Enter DP number" required>
                                            @error('dp_no')
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="nin" class="form-control @error('nin') is-invalid @enderror" 
                                                   value="{{ old('nin') }}" placeholder="Enter NIN" maxlength="11">
                                            @error('nin')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="bvn" class="form-control @error('bvn') is-invalid @enderror" 
                                                   value="{{ old('bvn') }}" placeholder="Enter BVN" maxlength="11">
                                            @error('bvn')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="mda" class="form-control @error('mda') is-invalid @enderror" 
                                                   value="{{ old('mda') }}" placeholder="Enter MDA" required>
                                            @error('mda')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                ...
                                <div class="form-group d-flex gap-2 justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-primary">
                                        <i class="fe fe-save me-1"></i> Save Civil Servant
                                    </button>
                                </div>
                            </form>
                </div>
