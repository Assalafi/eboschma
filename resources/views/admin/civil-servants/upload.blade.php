        ...
        <div class="col-lg-12 col-md-12">
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <!-- Upload Form -->
                    <form action="{{ route('civil-servants.upload.excel') }}" method="POST" enctype="multipart/form-data" id="upload-form">
                        @csrf
            ...
            <div class="card custom-card">
                <div class="card-body">
                    ...
                    <div class="alert alert-warning">
                        ...
                        Only <strong>dp_no</strong> is required. All other fields (fullname, NIN, gender, DOB, etc.) are optional and can be left empty.
                    </div>
                    ...
                    <div class="alert alert-info">
                        ...
                        <br><strong>Tip:</strong> To preserve leading zeros in Excel (e.g., 00001), format the column as <strong>Text</strong> before entering data, or prefix with an apostrophe (e.g., '00001).
                    </div>
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="8" class="text-center text-muted"><em>All other fields are optional - can be left empty</em></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="row mt-3">
                                <div class="col-md-6">
                                    ...
                                    <ul class="list-unstyled">
                                        <li><i class="fe fe-check text-success me-1"></i> <strong>dp_no:</strong> Unique DP number <span class="badge bg-danger">Required</span></li>
                                    </ul>
                                </div>
                                <div class="col-md-6">
                                    <h6>Optional Fields:</h6>
                                    <ul class="list-unstyled">
                                        <li><i class="fe fe-info text-info me-1"></i> <strong>fullname:</strong> Full name of civil servant</li>
                                        <li><i class="fe fe-info text-info me-1"></i> <strong>nin:</strong> National Identity Number (max 11 digits)</li>
                                        <li><i class="fe fe-info text-info me-1"></i> <strong>bvn:</strong> Bank Verification Number (max 11 digits)</li>
                                        <li><i class="fe fe-info text-info me-1"></i> <strong>dob:</strong> Date of birth (YYYY-MM-DD format)</li>
                                        <li><i class="fe fe-info text-info me-1"></i> <strong>gender:</strong> Must be "Male" or "Female"</li>
                                        <li><i class="fe fe-info text-info me-1"></i> <strong>state:</strong> State of origin/residence</li>
                                        <li><i class="fe fe-info text-info me-1"></i> <strong>lga:</strong> Local Government Area</li>
                                        <li><i class="fe fe-info text-info me-1"></i> <strong>mda:</strong> Ministry/Department/Agency</li>
                                    </ul>
                                </div>
                            </div>
                </div>
...
$(document).ready(function() {
    $('#upload-form').on('submit', function() {
        ...
        $('#upload-btn').prop('disabled', true).html('<i class="fe fe-spinner fa-spin me-1"></i> Uploading...');
