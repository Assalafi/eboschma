                                ...
                                <div class="row mt-4">
                                    <div class="col-12">
                                        <div class="alert alert-primary">
                                            ...
                                            <strong>Note:</strong> After creating the facility, you can assign services through
                                            the
                                            <a href="{{ route('facility-services.index') }}" class="alert-link">Facility
                                                Services Management</a> system.
                                        </div>
                                    </div>
                                </div>
                            @endcan
