                        ...
                        <form action="{{ route('facilities.update', $facility) }}" method="POST">
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="name" class="form-label">Facility Name <span
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('type') is-invalid @enderror" id="type"
                                        ...
                                        @foreach ($types as $type)
                                            <option value="{{ $type }}"
                                                {{ old('type', $facility->type) == $type ? 'selected' : '' }}>
                                                {{ $type }}
                                            </option>
                                        @endforeach
                                    </select>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-3">
                                    <label for="lga" class="form-label">Local Government Area <span
                                            class="text-danger">*</span></label>
                                    <select class="form-select @error('lga') is-invalid @enderror" id="lga"
                                        name="lga" required>
                                        <option value="">Select LGA</option>
                                        @foreach ($lgas as $lga)
                                            <option value="{{ $lga }}"
                                                {{ old('lga', $facility->lga) == $lga ? 'selected' : '' }}>
                                                {{ $lga }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select class="form-select @error('ward') is-invalid @enderror" id="ward"
                                        name="ward" required>
                            ...
                            @php
                                $facilityServices = $facility->facilityServices()->with('serviceItem')->get();
                            @endphp
                                    ...
                                    <div class="col-12">
                                        <div class="alert alert-info d-flex justify-content-between align-items-center">
                                            <div>
                                                ...
                                                This facility has {{ $facilityServices->count() }} service(s) assigned.
                                                Use the dedicated service management system to add or modify services.
                                            </div>
                                            <a href="{{ route('facility-services.index') }}?facility={{ $facility->id }}"
                                                class="btn btn-sm btn-primary">
                                                <i class="fe fe-briefcase me-1"></i> Manage Services
                                            </a>
                                        </div>
                                    </div>
                                </div>
