                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <div>
                                    ...
                                    <p class="text-muted mb-0">Assign multiple nurses to a ward</p>
                                </div>
                                <div>
                                    <a href="{{ route('nurse-ward.index') }}" class="btn btn-outline-secondary">
                                        <i class="fe fe-arrow-left me-1"></i> Back to Assignments
                                    </a>
                                </div>
                            </div>

                            <form method="POST" action="{{ route('nurse-ward.store') }}" id="nurseWardForm">
                                @csrf
                                ...
                                <div class="alert alert-info">
                                    ...
                                    Select a facility and ward first, then assign nurses below. You can assign multiple
                                    nurses at once.
                                </div>
                                ...
                                <div class="mb-4">
                                    <button type="button" id="addAssignment" class="btn btn-outline-primary">
                                        <i class="fe fe-plus me-1"></i> Add Another Nurse
                                    </button>
                                </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            function getNurseOptions() {
                let options = '<option value="">Select Nurse</option>';
