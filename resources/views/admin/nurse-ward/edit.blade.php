                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-center mb-4">
                                <div>
                                    ...
                                    <p class="text-muted mb-0">Update nurse ward assignment</p>
                                </div>
                                <div>
                            ...
                            <form method="POST" action="{{ route('nurse-ward.update', $assignment->id) }}">
                                @csrf
                                @method('PUT')

                                <div class="row mb-3">
                                    <div class="col-md-6">
                                        <label for="user_id" class="form-label">Nurse <span
