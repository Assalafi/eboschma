    ...
    <div class="row">
        <div class="col-lg-10 offset-lg-1">
            <div class="card custom-card border-0 shadow-sm">
                <div class="card-body">
                    <div class="mb-4">
                        <h6 class="main-content-label mb-1" style="color: #01542B;">Create New Role</h6>
                        <p class="card-sub-title" style="color: #01542B;">Create a role and assign permissions</p>
                    </div>
                    ...
                    <form action="{{ route('roles.store') }}" method="POST">
                        ...
                        <div class="form-group mt-4">
                            <button type="submit" class="btn btn-primary" style="background-color: #01542B; border-color: #01542B;">
                                <i class="fe fe-save"></i> Create Role
                            </button>
