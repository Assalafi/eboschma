                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center mb-4">
                            <div>
                                ...
                                <p class="card-sub-title" style="color: #01542B;">View role information and assigned
                                    permissions</p>
                            </div>
                            <div>
                                @can('role.edit')
                                ...
                                <div class="form-group">
                                    ...
                                    <p class="form-control-plaintext">
                                        <span class="badge badge-lg"
                                            style="background-color: #01542B; color: white; font-size: 16px; padding: 8px 15px;">
                                            {{ $role->name }}
                                        </span>
                                    </p>
                                </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <h6 class="font-weight-bold mb-3">Assigned Permissions ({{ $role->permissions->count() }})
                                </h6>
                                        ...
                                        <div class="card mb-3">
                                            <div class="card-header" style="background-color: #01542B; color: white;">
                                                <h6 class="mb-0 text-capitalize">
                                                    <i class="fe fe-shield"></i> {{ str_replace('_', ' ', $module) }}
                                                    Management
                                                </h6>
                                            </div>
                                            <div class="card-body">
                                                    ...
                                                    @foreach ($perms as $perm)
                                                        <div class="col-md-4 col-lg-3 mb-2">
                                                            <span class=""
                                                                ...
                                                                {{ ucfirst(str_replace('_', ' ', explode('.', $perm->name)[1])) }}
                                                            </span>
                                                        </div>
                                                    @endforeach
                                                </div>
