            ...
            <div class="card custom-card border-0 shadow-sm">
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <div>
                            @can('staff.edit')
                            <a href="{{ route('staff.edit', $staff) }}" class="btn btn-primary btn-sm" style="background-color: #01542B; border-color: #01542B;">
                        ...
                        <div class="col-md-12">
                            ...
                            @if($staff->roles->count() > 0)
                                @foreach($staff->roles as $role)
                                    <span class="badge badge-lg mr-2 mb-2" style="background-color: #01542B; color: white; font-size: 14px; padding: 8px 12px;">
                                        {{ $role->name }}
                                    </span>
                                @endforeach
                            @else
                        ...
                        <div class="col-md-12">
                            ...
                            @if($staff->getAllPermissions()->count() > 0)
                                ...
                                @foreach($permissions as $module => $perms)
                                    <div class="mb-3">
                                        <h6 class="text-capitalize" style="color: #01542B;">{{ str_replace('_', ' ', $module) }}</h6>
                                        <div class="pl-3">
