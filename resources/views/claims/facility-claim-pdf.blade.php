...
<table style="margin-top:-1px">
    <tr class="sec-hdr"><td colspan="8">Services Provided<br>Medication(s)</td></tr>
    <tr class="items">
    ...
    @empty
        <tr class="items"><td colspan="8" style="text-align:center;color:#999">No medications</td></tr>
    @endforelse
    <tr class="sub">
