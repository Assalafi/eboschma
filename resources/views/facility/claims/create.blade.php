                                            ...
                                            <div class="card">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="alert alert-info mt-3">
                                                        <strong>ℹ️ Note:</strong> Review all tabs before submitting the
                                                        claim.
                                    ...
                                    <div class="col-12">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                ...
                                                @else
                                                    <div class="alert alert-info">No services ordered for this encounter.
                                                    </div>
                                                @endif
    ...
    @push('scripts')
        <script>
            ...
            function validateAndSubmit() {
                ...
                let grandTotal = parseFloat(grandTotalText.replace(/[₦,]/g, '')) || 0;

                // Check if total is 0
                if (grandTotal === 0) {
                    alert(
                        '❌ Cannot create claim with ₦0.00 total amount!\n\nPlease ensure at least one medication or service is added with a valid amount.');
                    return false;
                }

                // Show confirmation dialog
                let confirmMessage = '📋 Are you sure you want to create this claim?\n\n';
                confirmMessage += 'Total Amount: ' + grandTotalText + '\n';
                confirmMessage += 'Claim Type: ' + $('select[name="claim_type"] option:selected').text() + '\n\n';
                confirmMessage += 'Click OK to confirm or Cancel to go back.';

                if (confirm(confirmMessage)) {
                    // Show loading state
                    $('button[type="submit"]').prop('disabled', true).html(
                        '<i class="ti-loading fa-spin mr-1"></i> Creating Claim...');
                    return true;
                } else {
                    return false;
                }
