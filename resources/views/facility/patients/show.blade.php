            ...
            <div class="col-12">
                <div class="d-md-flex justify-content-between align-items-start mb-4">
                    <div class="mb-3 mb-md-0">
                        <h1 class="page-title mb-2" style="color: #01542B; font-size: 24px; font-weight: 700;">Patient Details
                        </h1>
                        <p class="text-muted mb-0">View complete patient information and records</p>
                    </div>
                    <div>
                        <a href="{{ route('facility.patients.index') }}" class="btn btn-outline-secondary me-2">
                            <i class="ti-arrow-left me-1"></i> Back to Patients
                        </a>
                ...
                @php
                    if ($patient->enrollee_type === 'beneficiary') {
                        ...
                        $photo = $patient->beneficiary_photo ?? null;
                        $gender = $patient->beneficiary_gender ?? null;
                        $dob = $patient->date_of_birth ?? null;
                    } elseif ($patient->enrollee_type === 'child') {
                        $name = $patient->child_name ?? 'N/A';
                        $photo = $patient->child_photo ?? null;
                        $gender = $patient->child_gender ?? null;
                        $dob = $patient->child_dob ?? null;
                    } else {
                        $name = $patient->spouse_name ?? 'N/A';
                        $photo = $patient->spouse_photo ?? null;
                        $gender = $patient->spouse_gender ?? null;
                        $dob = $patient->spouse_dob ?? null;
                    }
                @endphp
                        ...
                        <div class="card border-0 shadow-sm mt-3" style="border-radius: 12px;">
                            <div class="card-body p-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <span class="text-muted">File Number</span>
                                        <span class="text-muted fw-semibold">{{ $patient->file_number }}</span>
                                    </div>
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                            ...
                            <div class="card-body p-4">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <p class="mb-0">{{ $patient->beneficiary_lga ?? 'Not specified' }}</p>
                                    </div>
                                    <div class="col-md-6 mb-3">
                                        <label class="form-label text-muted small">State</label>
                                        <p class="mb-0">{{ $patient->beneficiary_state ?? 'Not specified' }}</p>
                                    </div>
                                </div>
                            </div>
                        </div>
