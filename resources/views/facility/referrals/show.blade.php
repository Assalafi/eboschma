        ...
        <div class="page-header">
            <div class="page-leftheader">
                ...
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('facility.referrals.index') }}">Referrals</a></li>
                    <li class="breadcrumb-item active" aria-current="page">REF-{{ $referral->id }}</li>
                </ol>
            </div>
            <div class="page-rightheader">
                <div class="btn-list">
                    <a href="{{ route('facility.referrals.index') }}" class="btn btn-secondary">
                            ...
                            <div class="col-12 text-right">
                                ...
                                @if (!$isOutgoing && $referral->status === \App\Models\ServiceReferral::STATUS_PENDING)
                                    ...
                                    <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                        ...
                                        <i class="ti-close mr-1"></i>Reject Referral
                                    </button>
                                @endif
        ...
        <div class="modal fade" id="acceptModal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ route('facility.referrals.update-status', $referral->id) }}" method="POST">
                        @csrf
                        <input type="hidden" name="status" value="{{ \App\Models\ServiceReferral::STATUS_ACCEPTED }}">
                        <div class="modal-header">
                            <h5 class="modal-title">Accept Referral</h5>
        ...
        <div class="modal fade" id="rejectModal" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ route('facility.referrals.update-status', $referral->id) }}" method="POST">
                        @csrf
                        <input type="hidden" name="status" value="{{ \App\Models\ServiceReferral::STATUS_REJECTED }}">
                        <div class="modal-header">
                ...
                <div class="modal-content">
                    <form action="{{ route('facility.referrals.update-status', $referral->id) }}" method="POST">
                        ...
                        <input type="hidden" name="status"
                            value="{{ \App\Models\ServiceReferral::STATUS_CANCELLED }}">
                        <div class="modal-header">
                            <h5 class="modal-title">Cancel Referral</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                        </div>
                        <div class="modal-body">
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Cancel</button>
                            <button type="submit" class="btn btn-warning">Cancel Referral</button>
                        </div>
                    </form>
                </div>
            </div>
