...
@section('title', 'Enumerator Enrollments')
        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                <div class="col">
                    ...
                    <h2 class="page-title">{{ $enumerator->fullname }} - Enrollments</h2>
                    <div class="text-muted mt-1">View all beneficiary enrollments created by {{ $enumerator->fullname }}</div>
                </div>
                <div class="col-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('reports.enumerators') }}" class="btn">
                        ...
                        <a href="{{ route('reports.enumerators.enrollments.export', $enumerator->id) }}" class="btn btn-primary">
                            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="display: inline; margin-right: 0.25rem;">
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    ...
                                    <div class="text-muted">{{ number_format($enrollments->total()) }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card card-sm">
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    <div class="font-weight-medium">Active Enrollments</div>
                                    <div class="text-muted">{{ number_format($enrollments->where('status', 'active')->count()) }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    ...
                                    <div class="text-muted">{{ number_format($enrollments->pluck('facility_id')->unique()->count()) }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card-body">
                            <div class="row align-items-center">
                                ...
                                <div class="col">
                                    ...
                                    <div class="text-muted">{{ number_format($enrollments->where('created_at', '>=', now()->startOfMonth())->count()) }}</div>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title">Beneficiary Enrollments</h3>
                            ...
                            <div class="d-flex">
                                ...
                                <div class="ms-auto text-muted">
                                    ...
                                    <div class="ms-2 d-inline-block">
                                        <input type="text" class="form-control form-control-sm" placeholder="Search enrollments...">
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <table class="table table-vcenter table-hover">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $enrollment->facility->name ?? 'N/A' }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="btn-list flex-nowrap">
                                                <a href="{{ route('beneficiaries.show', $enrollment->id) }}" class="btn" title="View Details">
                                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="8" class="text-center">No enrollments found for this enumerator</td>
                                    </tr>
                                    @endforelse
                                </tbody>
                            </table>
                            ...
                            <div class="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center gap-3">
                                ...
                                <div class="overflow-auto w-100 w-md-auto">
                                    @if ($enrollments->hasPages())
                                        <nav aria-label="Enumerator enrollments pagination">
                                            <ul class="pagination pagination-sm mb-0 flex-nowrap">
                                                {{-- Previous Page Link --}}
                                                @if ($enrollments->onFirstPage())
                                                    <li class="page-item disabled"><span class="page-link">Prev</span></li>
                                                @else
                                                    <li class="page-item"><a class="page-link" href="{{ $enrollments->previousPageUrl() }}" rel="prev">Prev</a></li>
                                                @endif
                                                ...
                                                @if ($enrollments->hasMorePages())
                                                    <li class="page-item"><a class="page-link" href="{{ $enrollments->nextPageUrl() }}" rel="next">Next</a></li>
                                                @else
