...
<head>
    <meta charset="utf-8">
    <title>CRM Status Report - {{ ucfirst(str_replace('_', ' ', request('status'))) }}</title>
    <style>
...
<body>
    ...
    <div class="header">
        ...
        <p>Status: {{ ucfirst(str_replace('_', ' ', request('status'))) }} - Generated on {{ date('F j, Y \a\t H:i') }}
        </p>
    </div>

    <!-- Filter Information -->
    <div class="filters-info">
        <strong>Filter Applied:</strong> Status = {{ ucfirst(str_replace('_', ' ', request('status'))) }}
    ...
    <div class="summary-section">
        ...
        <div class="summary-grid">
            <div class="summary-row">
                ...
                <div class="summary-cell">
                    <div class="summary-box">
                        <div class="summary-number">{{ number_format($tickets->whereNotNull('assigned_to')->count()) }}
                        </div>
    ...
    <div class="table-section">
        ...
        @if ($tickets->isEmpty())
            <div style="text-align: center; padding: 40px; color: #666;">
                <p style="font-size: 14px; margin: 0;">No tickets found with {{ request('status') }} status.</p>
            </div>
        @endif
    </div>
    ...
    <!-- Footer -->
    <div class="footer">
        <p>CRM Status Report - Generated by Boschma Management System</p>
