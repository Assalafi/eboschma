...
<div class="page-header d-print-none">
    <div class="container-xl">
        ...
        <h2 class="page-title"><i class="ti-wallet me-2 text-success"></i>Fund Wallet</h2>
    </div>
</div>
<div class="page-body">
    <div class="container-xl">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="card">
                    <div class="card-header"><h3 class="card-title">Add Funds</h3></div>
                    <div class="card-body">
                        <form action="{{ route('wallets.fund', $wallet->id) }}" method="POST">
                            ...
                            <button type="submit" class="btn btn-success w-100"><i class="ti-plus me-1"></i>Fund Wallet</button>
